    ...
    class queue:
        ...
        def dequeue(self):
            if self.isEmpty():
                ...
                print("Rasa : ", rasa)
                print("-------------------------")
            print("Lanjutkan [ENTER] dan pilih menu pembayaran")
            input()
            self.menu()
        ...
        def menu(self):
            ...
            if pil ==1:
                ...
                while True :
                    ...
                    if kode == 1:
                        self.pesanan.append("Cone(maksimal 2 rasa)")
                        self.harga.append(30000)
                    ...
                    pesanan_lain = input("Ada pesanan dengan ukuran yang sama atau berbeda ?\nTekan (YES/NO) : ")
                    if pesanan_lain == "NO" :
                        print ("")
                        break
